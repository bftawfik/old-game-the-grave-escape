...
//        console.log(addOneToArray([67]));
//        this.assets.level1Map.setTileIndexCallback(addOneToArray([58,59]), function(player, tile){console.log(tile)}, this, this.assets.layers.background);
...
//        this.game.debug.spriteCorners(this.assets.hero, true, true);
    ...
    getDefaults: function(){
        return {
            ...
            boxes: {
                coins: [5, 6, 8 ,0], //--19
                blueDiamond: [5, 6, 8 ,0], //--19
                redDiamond: [5, 6, 8 ,0], //--19
            },
            barrels: {
                coins: [5, 6, 8 ,0], //--19
                blueDiamond: [5, 6, 8 ,0], //--19
            ...
            circularVases: {
                coins: [8 ,0 ,3 ,1, 4], //--16
                blueDiamond: [8 ,0 ,3 ,1, 4], //--16
                redDiamond: [8 ,0 ,3 ,1, 4], //--16
            },
            tallVases: {
                coins: [5, 6, 8 ,0, 2], //--21
                blueDiamond: [5, 6, 8 ,0, 2], //--21
                redDiamond: [5, 6, 8 ,0, 2], //--21
            },
            mummiesGenerators: [
                {enabeled: true},
                {enabeled: false}
...
//                console.log(this);
    ...
    mummyHitHeroCheck: function(hero, mummy){
        var horCheck = false;
        var verCheck = false;
        if(Math.abs(hero.x-mummy.x) <= hero.width){
            var horCheck = true;
        }
...
//        console.log(hero.x,hero.y, mummy.x, mummy.y);
        if(!hero.isMummy){
...
//        console.log("checkSpikesCollidHero");
        ...
        if(tile !== null){
            if(tile.index == addOneToArray(this.level1.map.spikesTiles)[0]){
